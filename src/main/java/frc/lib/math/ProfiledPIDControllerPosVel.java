 ...
 */
public class ProfiledPIDControllerPosVel implements Sendable {
     ...
     */
    public ProfiledPIDControllerPosVel(double Kp, double Ki, double Kd,
    ...
    public ProfiledPIDControllerPosVel(double Kp, double Ki, double Kd,
        ...
        SendableRegistry.add(this, "ProfiledPIDControllerPosVel", instances);
     ...
     */
    public State calculate(double measurement) {
        ...
        return new State(m_controller.calculate(measurement, m_setpoint.position),
            m_setpoint.velocity);
    }
     ...
     * @return The controller's next output.
     */
    public State calculate(double measurement, TrapezoidProfile.State goal) {
        setGoal(goal);
     ...
     * @return The controller's next output.
     */
    public State calculate(double measurement, double goal) {
        setGoal(goal);
        return calculate(measurement);
    }
